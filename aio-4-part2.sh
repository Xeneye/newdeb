...
echo "------------------"
sudo apt install -y firefox-esr firefox-esr-l10n-en-gb thunderbird thunderbird-l10n-en-gb lightning-l10n-en-gb hunspell hunspell-en-gb hyphen-en-gb telegram-desktop filezilla soundconverter audacity quodlibet python-paho-mqtt python3-paho-mqtt kakasi gimp inkscape blender handbrake steam
clear
